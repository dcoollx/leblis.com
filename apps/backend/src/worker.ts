import {  mapStripeToBigin, respond, } from "./utils";
    ...
    try {
        ...
        throw e
            ...
            switch(event.type){
                ...
                const line_items = await stripe.checkout.sessions.listLineItems(checkout.id)
            ...
            console.log('processed', products.length, 'items')
                ...
                await stripe.checkout.sessions.update(checkout.id, { metadata: { orderNumber }});
